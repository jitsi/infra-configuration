...
local muc_domain = 'internal.auth.' .. muc_domain_base;
local jigasi_brewery_room_jid = 'jigasibrewery@' .. muc_domain
local jigasi_bare_jid = "jigasi@auth." .. muc_domain_base;
local focus_jid = "jigasibrewery@internal.auth." .. muc_domain_base .. "/focus"
